...
getGrammerApi(){
  this.http.get<any[]>('api/grammars/getTutorial/'+this.back.tutotrialid)
  .subscribe(
    (response: any[]) => {
...
getQuizApi(){
  ...
  this.http.get<any>('api/v1/quiz/tutorial/'+this.back.tutotrialid)
  .subscribe(
    (response: any) => {
      console.log(response)
      if(response != null)
...
getStoryApi(){
  this.http.get<any>('api/v1/story/tutorial/'+this.back.tutotrialid)
  .subscribe(
    (response: any) => {
      debugger
      if(response != null)
...
debugger
  this.http.post<any>('api/grammars', this.grammarData)
  .subscribe(
    response => {
...
this.http.get<FormData>('api/grammars/'+id)
.subscribe(
  (response: any) => {
    console.log(response)
...
onsubmitEditGrammer()
{
  ...
  this.http.post<any[]>('api/grammars/delete/'+this.formDataGrammer.grammar_id,null)
.subscribe(
  (response: any[]) => {
    console.log(response)
    debugger
    ...
    this.http.post<any>('api/grammars', this.formDataGrammer)
    .subscribe(
      response => {
...
this.http.post<any[]>('api/grammars/delete/'+id,null)
.subscribe(
  (response: any[]) => {
    console.log(response)
...
deleteQuiz(id:any)
{
  ...
  this.http.post<any>('api/v1/quiz/delete/'+id,null)
  .subscribe(
    (response: any) => {
...
debugger
this.http.post<any>('api/v1/quiz', this.quiz)
.subscribe(
response => {
...
// });
this.http.post<any>('api/v1/quiz/delete/'+this.quizEdit.id,null)
.subscribe(
  (response: any) => {
    debugger
    console.log(response)
...
Array.from(this.quizEdit.questions, (question:any) => {
  ...
  question.id = 0
    ...
    this.http.post<any>('api/v1/quiz', this.quizEdit)
.subscribe(
response => {
...
private apiUrl = 'api/v1/quiz/update';
...
editStory(id:any){
  ...
  this.http.get<FormDataStory>('api/v1/story/tutorial/'+this.back.tutotrialid)
  .subscribe(
    (response: any) => {
      console.log(response)
      debugger
...
{ this.deleteStorystatus = true
  this.http.post<any[]>('api/v1/story/delete/'+id,null)
  .subscribe(
    (response: any[]) => {
      console.log(response)
...
this.editStorystatus =true
  ...
  this.http.post<any[]>('api/v1/story/delete/'+this.back.storyid,null)
.subscribe(
  (response: any[]) => {
    console.log(response)
    debugger
   ...
   debugger
    this.http.post<any>('api/v1/story', this.FormDataStory)
    .subscribe(
      response => {
        debugger
...
this.storyAdd.tutorialId = this.back.tutotrialid
  ...
  this.http.post<any>('api/v1/story', this.storyAdd)
  .subscribe(
    response => {
      debugger
